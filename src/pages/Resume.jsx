  ...
  return (
    <Wrap>
      ...
      <TitleBox>
        ...
        <Description>
          저는 새로운 도전을 즐기며, 열정을 바탕으로 빠르게 실천에 옮기는 성향을
          가지고 있습니다.
          <br />
          특히 사람들과의 소통을 중요시하며, 이를 통해 성장해왔습니다.
          <br />
          웹개발에 관심이 생긴 이후, 프론트엔드 부트캠프에 참여해 매일 꾸준히
          미팅을 진행하며 협업과 커뮤니케이션 능력을 쌓았습니다.
          <br />
          프로젝트 진행 중 문제 해결을 위한 협업에 적극적으로 참여하며 팀워크의
          중요성을 몸소 느꼈고
          <br />
          이를 통해 실력뿐만 아니라 팀 내에서의 역할 수행에도 자신감을
          얻었습니다.
          <br />
          다양한 도전과 경험을 통해 여러 기술 스택을 쌓아, <br />
          최고의 UI/UX를 제공할 수 있는 프론트엔드 개발자로 성장하고 싶습니다.
          <br />
        </Description>
      </TitleBox>
      <TitleBox>
